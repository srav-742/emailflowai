...
const shellNavItems = [
  ...
  { path: '/automation', label: 'NL Automation', kicker: 'Intelligent rules OS' },
  { path: '/documents', label: 'Document Intel', kicker: 'Universal OCR & AI parser' },
  { path: '/omnichannel', label: 'Omnichannel Hub', kicker: 'Unified multi-channel OS' },
  { path: '/campaigns', label: 'Smart Campaigns', kicker: 'Outbound engagement & drips' },
...
const pageTitles = {
  ...
  '/automation': 'Natural-language rule compiler',
  '/documents': 'Advanced Document Intelligence',
  '/omnichannel': 'Omnichannel Command Center',
  '/campaigns': 'Smart Drip Campaigns Control Center',
  '/focus': 'Focus Today',
...
const pageDescriptions = {
  ...
  '/automation': 'Define inbox workflows, auto-label stripe invoices, auto-reply recruiting, or forward emails to Slack using natural language.',
  '/documents': 'Extract structured data, run OCR, and perform semantic natural-language search over invoices, contracts, resumes, and spreadsheets.',
  '/omnichannel': 'Unified AI communication hub for email, SMS, Slack, Teams, WhatsApp, and Telegram.',
  '/campaigns': 'Design visual drips, intelligent follow-up workflows, and AI-personalized outreach sequences.',
